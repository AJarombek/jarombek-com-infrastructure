...
resource "aws_s3_bucket_object" "jarombek-png" {
  ...
  etag = "${filemd5("${path.cwd}/assets/jarombek.png")}"
}
...
resource "aws_s3_bucket_object" "blizzard-png" {
  ...
  etag = "${filemd5("${path.cwd}/assets/blizzard.png")}"
}
...
resource "aws_s3_bucket_object" "bulk-insert-png" {
  ...
  etag = "${filemd5("${path.cwd}/assets/bulk-insert.png")}"
}
...
resource "aws_s3_bucket_object" "common-user-png" {
  ...
  etag = "${filemd5("${path.cwd}/assets/common-user.png")}"
}

resource "aws_s3_bucket_object" "computer-jpg" {
  bucket = "${aws_s3_bucket.assets-jarombek.id}"
  key = "computer.jpg"
  source = "assets/computer.jpg"
  etag = "${filemd5("${path.cwd}/assets/computer.jpg")}"
}
...
resource "aws_s3_bucket_object" "database-er-png" {
  ...
  etag = "${filemd5("${path.cwd}/assets/Database-ER.png")}"
}
...
resource "aws_s3_bucket_object" "diamond-uml-png" {
  ...
  etag = "${filemd5("${path.cwd}/assets/diamond-uml.png")}"
}
...
resource "aws_s3_bucket_object" "down-png" {
  ...
  etag = "${filemd5("${path.cwd}/assets/down.png")}"
}
...
resource "aws_s3_bucket_object" "down-black-png" {
  ...
  etag = "${filemd5("${path.cwd}/assets/down-black.png")}"
}
...
resource "aws_s3_bucket_object" "dynamic-jsx-png" {
  ...
  etag = "${filemd5("${path.cwd}/assets/dynamic-jsx.png")}"
}
...
resource "aws_s3_bucket_object" "error-message-png" {
  ...
  etag = "${filemd5("${path.cwd}/assets/error-message.png")}"
}
...
resource "aws_s3_bucket_object" "flag-svg" {
  ...
  etag = "${filemd5("${path.cwd}/assets/flag.svg")}"
}
...
resource "aws_s3_bucket_object" "home-png" {
  ...
  etag = "${filemd5("${path.cwd}/assets/home.png")}"
}
...
resource "aws_s3_bucket_object" "jarombek-home-background-jpg" {
  ...
  etag = "${filemd5("${path.cwd}/assets/jarombek-home-background.jpg")}"
}
...
resource "aws_s3_bucket_object" "mean-stack-png" {
  ...
  etag = "${filemd5("${path.cwd}/assets/MEAN-Stack.png")}"
}
...
resource "aws_s3_bucket_object" "kayak-jpg" {
  ...
  etag = "${filemd5("${path.cwd}/assets/kayak.jpg")}"
}
...
resource "aws_s3_bucket_object" "login-component-png" {
  ...
  etag = "${filemd5("${path.cwd}/assets/login-component.png")}"
}
...
resource "aws_s3_bucket_object" "main-component-png" {
  ...
  etag = "${filemd5("${path.cwd}/assets/main-component.png")}"
}
...
resource "aws_s3_bucket_object" "meowcat-png" {
  ...
  etag = "${filemd5("${path.cwd}/assets/meowcat.png")}"
}
...
resource "aws_s3_bucket_object" "search-png" {
  ...
  etag = "${filemd5("${path.cwd}/assets/search.png")}"
}
...
resource "aws_s3_bucket_object" "signup-component-png" {
  ...
  etag = "${filemd5("${path.cwd}/assets/signup-component.png")}"
}
...
resource "aws_s3_bucket_object" "triangles-png" {
  ...
  etag = "${filemd5("${path.cwd}/assets/triangles.png")}"
}
...
resource "aws_s3_bucket_object" "dyslexie-bold-ttf" {
  ...
  etag = "${filemd5("${path.cwd}/assets/fonts/dyslexie-bold.ttf")}"
}
...
resource "aws_s3_bucket_object" "fantasque-sans-mono-bold-ttf" {
  ...
  etag = "${filemd5("${path.cwd}/assets/fonts/FantasqueSansMono-Bold.ttf")}"
}
...
resource "aws_s3_bucket_object" "longway-regular-otf" {
  ...
  etag = "${filemd5("${path.cwd}/assets/fonts/Longway-Regular.otf")}"
}
...
resource "aws_s3_bucket_object" "sylexiad-sans-thin-ttf" {
  ...
  etag = "${filemd5("${path.cwd}/assets/fonts/SylexiadSansThin.ttf")}"
}
...
resource "aws_s3_bucket_object" "sylexiad-sans-thin-bold-ttf" {
  ...
  etag = "${filemd5("${path.cwd}/assets/fonts/SylexiadSansThin-Bold.ttf")}"
}
...
resource "aws_s3_bucket_object" "posts-11-6-17-graph-png" {
  ...
  etag = "${filemd5("${path.cwd}/assets/posts/11-6-17-FairfieldGraphImage.png")}"
}
...
resource "aws_s3_bucket_object" "posts-11-13-17-prompt-png" {
  ...
  etag = "${filemd5("${path.cwd}/assets/posts/11-13-17-prompt.png")}"
}
...
resource "aws_s3_bucket_object" "posts-11-21-17-results-png" {
  ...
  etag = "${filemd5("${path.cwd}/assets/posts/11-21-17-results.png")}"
}
...
resource "aws_s3_bucket_object" "posts-11-26-17-results-png" {
  ...
  etag = "${filemd5("${path.cwd}/assets/posts/11-26-17-results.png")}"
}
...
resource "aws_s3_bucket_object" "posts-12-30-17-mongodb-png" {
  ...
  etag = "${filemd5("${path.cwd}/assets/posts/12-30-17-mongodb.png")}"
}
...
resource "aws_s3_bucket_object" "posts-12-30-17-restapi-png" {
  ...
  etag = "${filemd5("${path.cwd}/assets/posts/12-30-17-restapi.png")}"
}
...
resource "aws_s3_bucket_object" "posts-12-30-17-xmlresponse-png" {
  ...
  etag = "${filemd5("${path.cwd}/assets/posts/12-30-17-xmlresponse.png")}"
}
...
resource "aws_s3_bucket_object" "posts-12-30-17-xmlresponsetext-png" {
  ...
  etag = "${filemd5("${path.cwd}/assets/posts/12-30-17-xmlresponsetext.png")}"
}
...
resource "aws_s3_bucket_object" "posts-1-14-18-html-png" {
  ...
  etag = "${filemd5("${path.cwd}/assets/posts/1-14-18-html.png")}"
}
...
resource "aws_s3_bucket_object" "posts-1-14-18-webresult-png" {
  ...
  etag = "${filemd5("${path.cwd}/assets/posts/1-14-18-webresult.png")}"
}
...
resource "aws_s3_bucket_object" "posts-1-27-17-postlazy-png" {
  ...
  etag = "${filemd5("${path.cwd}/assets/posts/1-27-17-postlazy.png")}"
}
...
resource "aws_s3_bucket_object" "posts-1-27-17-prelazy-png" {
  ...
  etag = "${filemd5("${path.cwd}/assets/posts/1-27-17-prelazy.png")}"
}
...
resource "aws_s3_bucket_object" "posts-5-20-18-blockchain-png" {
  ...
  etag = "${filemd5("${path.cwd}/assets/posts/5-20-18-blockchain.png")}"
}
...
resource "aws_s3_bucket_object" "posts-5-20-18-simpleblock-png" {
  ...
  etag = "${filemd5("${path.cwd}/assets/posts/5-20-18-simpleblock.png")}"
}
...
resource "aws_s3_bucket_object" "posts-5-20-18-exercise-png" {
  ...
  etag = "${filemd5("${path.cwd}/assets/posts/5-20-18-exercise.png")}"
}
...
resource "aws_s3_bucket_object" "posts-5-31-18-seed-png" {
  ...
  etag = "${filemd5("${path.cwd}/assets/posts/5-31-18-seed.png")}"
}
...
resource "aws_s3_bucket_object" "posts-6-9-18-array-chain-png" {
  ...
  etag = "${filemd5("${path.cwd}/assets/posts/6-9-18-array-chain.png")}"
}
...
resource "aws_s3_bucket_object" "posts-6-9-18-function-chain-png" {
  ...
  etag = "${filemd5("${path.cwd}/assets/posts/6-9-18-function-chain.png")}"
}
...
resource "aws_s3_bucket_object" "posts-6-9-18-object-chain-png" {
  ...
  etag = "${filemd5("${path.cwd}/assets/posts/6-9-18-object-chain.png")}"
}
...
resource "aws_s3_bucket_object" "posts-6-9-18-prototype-traverse-png" {
  ...
  etag = "${filemd5("${path.cwd}/assets/posts/6-9-18-prototype-traverse.png")}"
}
...
resource "aws_s3_bucket_object" "posts-6-13-18-network-files-png" {
  ...
  etag = "${filemd5("${path.cwd}/assets/posts/6-13-18-network-files.png")}"
}
...
resource "aws_s3_bucket_object" "posts-6-13-18-writing-notes-gif" {
  ...
  etag = "${filemd5("${path.cwd}/assets/posts/6-13-18-writing-notes.gif")}"
}
...
resource "aws_s3_bucket_object" "posts-6-18-18-grid-0-png" {
  ...
  etag = "${filemd5("${path.cwd}/assets/posts/6-18-18-grid-0.png")}"
}
...
resource "aws_s3_bucket_object" "posts-6-18-18-grid-1-png" {
  ...
  etag = "${filemd5("${path.cwd}/assets/posts/6-18-18-grid-1.png")}"
}
...
resource "aws_s3_bucket_object" "posts-6-18-18-grid-2-png" {
  ...
  etag = "${filemd5("${path.cwd}/assets/posts/6-18-18-grid-2.png")}"
}
...
resource "aws_s3_bucket_object" "posts-7-4-18-groovy-png" {
  ...
  etag = "${filemd5("${path.cwd}/assets/posts/7-4-18-groovy-strict-type-check.png")}"
}
...
resource "aws_s3_bucket_object" "posts-8-5-18-graphql-png" {
  ...
  etag = "${filemd5("${path.cwd}/assets/posts/8-5-18-graphql.png")}"
}
...
resource "aws_s3_bucket_object" "posts-8-8-18-graphiql-png" {
  ...
  etag = "${filemd5("${path.cwd}/assets/posts/8-8-18-graphiql.png")}"
}
...
resource "aws_s3_bucket_object" "posts-8-5-18-restapi-png" {
  ...
  etag = "${filemd5("${path.cwd}/assets/posts/8-5-18-restapi.png")}"
}
...
resource "aws_s3_bucket_object" "posts-9-3-18-aws-png" {
  ...
  etag = "${filemd5("${path.cwd}/assets/posts/9-3-18-aws.png")}"
}
...
resource "aws_s3_bucket_object" "posts-9-3-18-web-png" {
  ...
  etag = "${filemd5("${path.cwd}/assets/posts/9-3-18-web.png")}"
}
...
resource "aws_s3_bucket_object" "posts-9-7-18-serverless-png" {
  ...
  etag = "${filemd5("${path.cwd}/assets/posts/9-7-18-serverless.png")}"
}
...
resource "aws_s3_bucket_object" "posts-9-21-18-jenkins01-png" {
  ...
  etag = "${filemd5("${path.cwd}/assets/posts/9-21-18-jenkins01.png")}"
}
...
resource "aws_s3_bucket_object" "posts-9-21-18-jenkins02-png" {
  ...
  etag = "${filemd5("${path.cwd}/assets/posts/9-21-18-jenkins02.png")}"
}
...
resource "aws_s3_bucket_object" "posts-9-21-18-jenkins03-png" {
  ...
  etag = "${filemd5("${path.cwd}/assets/posts/9-21-18-jenkins03.png")}"
}
...
resource "aws_s3_bucket_object" "posts-9-21-18-jenkins04-png" {
  ...
  etag = "${filemd5("${path.cwd}/assets/posts/9-21-18-jenkins04.png")}"
}
...
resource "aws_s3_bucket_object" "posts-9-21-18-jenkins05-png" {
  ...
  etag = "${filemd5("${path.cwd}/assets/posts/9-21-18-jenkins05.png")}"
}
...
resource "aws_s3_bucket_object" "posts-11-7-18-bar-chart-gif" {
  ...
  etag = "${filemd5("${path.cwd}/assets/posts/11-7-18-bar-chart.gif")}"
}
...
resource "aws_s3_bucket_object" "posts-11-24-18-angular-lifecycle-png" {
  ...
  etag = "${filemd5("${path.cwd}/assets/posts/11-24-18-angular-lifecycle.png")}"
}
...
resource "aws_s3_bucket_object" "posts-12-22-18-hierarchy1-png" {
  ...
  etag = "${filemd5("${path.cwd}/assets/posts/12-22-18-hierarchy1.png")}"
}
...
resource "aws_s3_bucket_object" "posts-12-22-18-hierarchy2-png" {
  ...
  etag = "${filemd5("${path.cwd}/assets/posts/12-22-18-hierarchy2.png")}"
}
...
resource "aws_s3_bucket_object" "posts-12-22-18-hierarchy3-png" {
  ...
  etag = "${filemd5("${path.cwd}/assets/posts/12-22-18-hierarchy3.png")}"
}
...
resource "aws_s3_bucket_object" "posts-1-19-19-react-lifecycles-gif" {
  ...
  etag = "${filemd5("${path.cwd}/assets/posts/1-19-19-react-lifecycles.gif")}"
}
...
resource "aws_s3_bucket_object" "posts-1-24-19-example-1-png" {
  ...
  etag = "${filemd5("${path.cwd}/assets/posts/1-24-19-example-1.png")}"
}
...
resource "aws_s3_bucket_object" "posts-1-24-19-example-2-png" {
  ...
  etag = "${filemd5("${path.cwd}/assets/posts/1-24-19-example-2.png")}"
}
...
resource "aws_s3_bucket_object" "posts-1-24-19-example-3-png" {
  ...
  etag = "${filemd5("${path.cwd}/assets/posts/1-24-19-example-3.png")}"
}
...
resource "aws_s3_bucket_object" "posts-1-29-19-horse-picture-1-jpg" {
  ...
  etag = "${filemd5("${path.cwd}/assets/posts/1-29-19-horse-picture-1.jpg")}"
}
...
resource "aws_s3_bucket_object" "posts-1-29-19-horse-picture-2-jpg" {
  ...
  etag = "${filemd5("${path.cwd}/assets/posts/1-29-19-horse-picture-2.jpg")}"
}
...
resource "aws_s3_bucket_object" "posts-3-12-19-cd-project-gif" {
  ...
  etag = "${filemd5("${path.cwd}/assets/posts/3-12-19-cd-project.gif")}"
}

resource "aws_s3_bucket_object" "posts-4-28-19-app-png" {
  bucket = "${aws_s3_bucket.assets-jarombek.id}"
  key = "posts/4-28-19-app.png"
  source = "assets/posts/4-28-19-app.png"
  etag = "${filemd5("${path.cwd}/assets/posts/4-28-19-app.png")}"
}

resource "aws_s3_bucket_object" "posts-5-13-19-k8s-master-png" {
  bucket = "${aws_s3_bucket.assets-jarombek.id}"
  key = "posts/5-13-19-k8s-master.png"
  source = "assets/posts/5-13-19-k8s-master.png"
  etag = "${filemd5("${path.cwd}/assets/posts/5-13-19-k8s-master.png")}"
}

resource "aws_s3_bucket_object" "posts-5-13-19-k8s-worker-png" {
  bucket = "${aws_s3_bucket.assets-jarombek.id}"
  key = "posts/5-13-19-k8s-worker.png"
  source = "assets/posts/5-13-19-k8s-worker.png"
  etag = "${filemd5("${path.cwd}/assets/posts/5-13-19-k8s-worker.png")}"
}

resource "aws_s3_bucket_object" "posts-5-13-19-k8s-cluster-png" {
  bucket = "${aws_s3_bucket.assets-jarombek.id}"
  key = "posts/5-13-19-k8s-cluster.png"
  source = "assets/posts/5-13-19-k8s-cluster.png"
  etag = "${filemd5("${path.cwd}/assets/posts/5-13-19-k8s-cluster.png")}"
}

resource "aws_s3_bucket_object" "posts-5-20-19-web-browser" {
  bucket = "${aws_s3_bucket.assets-jarombek.id}"
  key = "posts/5-20-19-web-browser.png"
  source = "assets/posts/5-20-19-web-browser.png"
  etag = "${filemd5("${path.cwd}/assets/posts/5-20-19-web-browser.png")}"
}

resource "aws_s3_bucket_object" "posts-5-20-19-aws-console" {
  bucket = "${aws_s3_bucket.assets-jarombek.id}"
  key = "posts/5-20-19-aws-console.png"
  source = "assets/posts/5-20-19-aws-console.png"
  etag = "${filemd5("${path.cwd}/assets/posts/5-20-19-aws-console.png")}"
}
...
resource "aws_s3_bucket_object" "angular-png" {
  ...
  etag = "${filemd5("${path.cwd}/assets/logos/angular.png")}"
}
...
resource "aws_s3_bucket_object" "apigateway-svg" {
  ...
  etag = "${filemd5("${path.cwd}/assets/logos/apigateway.svg")}"
}
...
resource "aws_s3_bucket_object" "assembly-png" {
  ...
  etag = "${filemd5("${path.cwd}/assets/logos/assembly.png")}"
}
...
resource "aws_s3_bucket_object" "aws-png" {
  ...
  etag = "${filemd5("${path.cwd}/assets/logos/aws.png")}"
}
...
resource "aws_s3_bucket_object" "awslambda-png" {
  ...
  etag = "${filemd5("${path.cwd}/assets/logos/awslambda.png")}"
}
...
resource "aws_s3_bucket_object" "babel-png" {
  ...
  etag = "${filemd5("${path.cwd}/assets/logos/babel.png")}"
}
...
resource "aws_s3_bucket_object" "batch-png" {
  ...
  etag = "${filemd5("${path.cwd}/assets/logos/batch.png")}"
}
...
resource "aws_s3_bucket_object" "bash-png" {
  ...
  etag = "${filemd5("${path.cwd}/assets/logos/bash.png")}"
}
...
resource "aws_s3_bucket_object" "bootstrap-png" {
  ...
  etag = "${filemd5("${path.cwd}/assets/logos/bootstrap.png")}"
}
...
resource "aws_s3_bucket_object" "c-png" {
  ...
  etag = "${filemd5("${path.cwd}/assets/logos/c.png")}"
}

resource "aws_s3_bucket_object" "cloudformation-png" {
  bucket = "${aws_s3_bucket.assets-jarombek.id}"
  key = "logos/cloudformation.png"
  source = "assets/logos/cloudformation.png"
  etag = "${filemd5("${path.cwd}/assets/logos/cloudformation.png")}"
}
...
resource "aws_s3_bucket_object" "cpp-png" {
  ...
  etag = "${filemd5("${path.cwd}/assets/logos/cpp.png")}"
}
...
resource "aws_s3_bucket_object" "csharp-png" {
  ...
  etag = "${filemd5("${path.cwd}/assets/logos/csharp.png")}"
}
...
resource "aws_s3_bucket_object" "css-png" {
  ...
  etag = "${filemd5("${path.cwd}/assets/logos/css.png")}"
}

resource "aws_s3_bucket_object" "docker-png" {
  bucket = "${aws_s3_bucket.assets-jarombek.id}"
  key = "logos/docker.png"
  source = "assets/logos/docker.png"
  etag = "${filemd5("${path.cwd}/assets/logos/docker.png")}"
}
...
resource "aws_s3_bucket_object" "d3-png" {
  ...
  etag = "${filemd5("${path.cwd}/assets/logos/d3.png")}"
}
...
resource "aws_s3_bucket_object" "ec2-png" {
  ...
  etag = "${filemd5("${path.cwd}/assets/logos/ec2.png")}"
}

resource "aws_s3_bucket_object" "eks-png" {
  bucket = "${aws_s3_bucket.assets-jarombek.id}"
  key = "logos/eks.png"
  source = "assets/logos/eks.png"
  etag = "${filemd5("${path.cwd}/assets/logos/eks.png")}"
}
...
resource "aws_s3_bucket_object" "es6-png" {
  ...
  etag = "${filemd5("${path.cwd}/assets/logos/es6.png")}"
}
...
resource "aws_s3_bucket_object" "es2017-png" {
  ...
  etag = "${filemd5("${path.cwd}/assets/logos/es2017.png")}"
}
...
resource "aws_s3_bucket_object" "express-png" {
  ...
  etag = "${filemd5("${path.cwd}/assets/logos/express.png")}"
}
...
resource "aws_s3_bucket_object" "github-png" {
  ...
  etag = "${filemd5("${path.cwd}/assets/logos/github.png")}"
}
...
resource "aws_s3_bucket_object" "graphql-png" {
  ...
  etag = "${filemd5("${path.cwd}/assets/logos/graphql.png")}"
}
...
resource "aws_s3_bucket_object" "groovy-png" {
  ...
  etag = "${filemd5("${path.cwd}/assets/logos/groovy.png")}"
}
...
resource "aws_s3_bucket_object" "gulp-svg" {
  ...
  etag = "${filemd5("${path.cwd}/assets/logos/gulp.svg")}"
}
...
resource "aws_s3_bucket_object" "haskell-png" {
  ...
  etag = "${filemd5("${path.cwd}/assets/logos/haskell.png")}"
}
...
resource "aws_s3_bucket_object" "html-png" {
  ...
  etag = "${filemd5("${path.cwd}/assets/logos/html.png")}"
}
...
resource "aws_s3_bucket_object" "java-png" {
  ...
  etag = "${filemd5("${path.cwd}/assets/logos/java.png")}"
}
...
resource "aws_s3_bucket_object" "java8-png" {
  ...
  etag = "${filemd5("${path.cwd}/assets/logos/java8.png")}"
}
...
resource "aws_s3_bucket_object" "jenkins-png" {
  ...
  etag = "${filemd5("${path.cwd}/assets/logos/jenkins.png")}"
}
...
resource "aws_s3_bucket_object" "js-png" {
  ...
  etag = "${filemd5("${path.cwd}/assets/logos/js.png")}"
}
...
resource "aws_s3_bucket_object" "json-png" {
  ...
  etag = "${filemd5("${path.cwd}/assets/logos/json.png")}"
}
...
resource "aws_s3_bucket_object" "jwt-png" {
  ...
  etag = "${filemd5("${path.cwd}/assets/logos/jwt.png")}"
}

resource "aws_s3_bucket_object" "k8s-png" {
  bucket = "${aws_s3_bucket.assets-jarombek.id}"
  key = "logos/k8s.png"
  source = "assets/logos/k8s.png"
  etag = "${filemd5("${path.cwd}/assets/logos/k8s.png")}"
}
...
resource "aws_s3_bucket_object" "mongodb-png" {
  ...
  etag = "${filemd5("${path.cwd}/assets/logos/mongodb.png")}"
}
...
resource "aws_s3_bucket_object" "mongoose-png" {
  ...
  etag = "${filemd5("${path.cwd}/assets/logos/mongoose.png")}"
}
...
resource "aws_s3_bucket_object" "neo4j-png" {
  ...
  etag = "${filemd5("${path.cwd}/assets/logos/neo4j.png")}"
}
...
resource "aws_s3_bucket_object" "nodejs-png" {
  ...
  etag = "${filemd5("${path.cwd}/assets/logos/nodejs.png")}"
}
...
resource "aws_s3_bucket_object" "oracle-png" {
  ...
  etag = "${filemd5("${path.cwd}/assets/logos/oracle.png")}"
}
...
resource "aws_s3_bucket_object" "php-svg" {
  ...
  etag = "${filemd5("${path.cwd}/assets/logos/php.svg")}"
}
...
resource "aws_s3_bucket_object" "powershell-png" {
  ...
  etag = "${filemd5("${path.cwd}/assets/logos/powershell.png")}"
}
...
resource "aws_s3_bucket_object" "python-png" {
  ...
  etag = "${filemd5("${path.cwd}/assets/logos/python.png")}"
}
...
resource "aws_s3_bucket_object" "rabbitmq-png" {
  ...
  etag = "${filemd5("${path.cwd}/assets/logos/rabbitmq.png")}"
}
...
resource "aws_s3_bucket_object" "react-png" {
  ...
  etag = "${filemd5("${path.cwd}/assets/logos/react.png")}"
}
...
resource "aws_s3_bucket_object" "sass-png" {
  ...
  etag = "${filemd5("${path.cwd}/assets/logos/sass.png")}"
}
...
resource "aws_s3_bucket_object" "sql-png" {
  ...
  etag = "${filemd5("${path.cwd}/assets/logos/sql.png")}"
}
...
resource "aws_s3_bucket_object" "swift-png" {
  ...
  etag = "${filemd5("${path.cwd}/assets/logos/swift.png")}"
}
...
resource "aws_s3_bucket_object" "tech-logos-svg" {
  ...
  etag = "${filemd5("${path.cwd}/assets/logos/tech_logos.svg")}"
}
...
resource "aws_s3_bucket_object" "tech-logos-white-svg" {
  ...
  etag = "${filemd5("${path.cwd}/assets/logos/tech_logos_white.svg")}"
}
...
resource "aws_s3_bucket_object" "terraform-png" {
  ...
  etag = "${filemd5("${path.cwd}/assets/logos/terraform.png")}"
}
...
resource "aws_s3_bucket_object" "travisci-png" {
  ...
  etag = "${filemd5("${path.cwd}/assets/logos/travisci.png")}"
}
...
resource "aws_s3_bucket_object" "ts-png" {
  ...
  etag = "${filemd5("${path.cwd}/assets/logos/ts.png")}"
}
...
resource "aws_s3_bucket_object" "unicode-png" {
  ...
  etag = "${filemd5("${path.cwd}/assets/logos/unicode.png")}"
}
...
resource "aws_s3_bucket_object" "vim-png" {
  ...
  etag = "${filemd5("${path.cwd}/assets/logos/vim.png")}"
}
...
resource "aws_s3_bucket_object" "webpack-png" {
  ...
  etag = "${filemd5("${path.cwd}/assets/logos/webpack.png")}"
}
...
resource "aws_s3_bucket_object" "yaml-png" {
  ...
  etag = "${filemd5("${path.cwd}/assets/logos/yaml.png")}"
}