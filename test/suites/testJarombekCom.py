...
class TestJarombekCom(unittest.TestCase):
    ...
    def test_ecs_task_running(self) -> None:
        ...
        jarombek_com_database_container = \
            [container for container in containers if container.get('name') == 'jarombek-com-database'][0]
        ...
        jarombek_com_container = \
            [container for container in containers if container.get('name') == 'jarombek-com'][0]
